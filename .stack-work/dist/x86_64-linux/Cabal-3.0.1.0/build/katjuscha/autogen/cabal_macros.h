...
/* package katjuscha-0.0.0 */
#ifndef VERSION_katjuscha
#define VERSION_katjuscha "0.0.0"
#endif /* VERSION_katjuscha */
#ifndef MIN_VERSION_katjuscha
#define MIN_VERSION_katjuscha(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_katjuscha */
...
#define CURRENT_COMPONENT_ID "katjuscha-0.0.0-IppXWNAtFzC51EuPNbixWz-katjuscha"
